...
*Figure 7: ค่าเฉลี่ย z-score ของตัวชี้วัดด้าน Growth (การเปลี่ยนแปลงระยะ 5 ปี) แสดงให้เห็นว่า Quality มีค่าการเติบโตสูงกว่า Junk อย่างสม่ำเสมอในทุก metric โดยมี Q–J Spread เป็นบวกในทุกตัวชี้วัด*
